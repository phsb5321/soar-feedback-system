 ...
 */
export class DrizzleFeedbackSubmissionAdapter implements FeedbackSubmissionPort {
  ...
  async submitFeedback(feedbackData: {
    ...
    try {
      ...
      throw new Error('Unknown database error occurred during feedback submission');
    }
  }
}
